...
//Fim de Carousel
  ...
  return (
    <Layout title="Components Page">
     <Base>
     <Container>
     <Slider value={value} min={0} max={100} step={1} onChange={handleSliderChange} />
      <p>Value: {value}</p>
     </Container>
     <Container>
     <MyComponent>
     ...
     <div>
      ...
      <tbody>
        ...
        <SnackBar onDismiss={handleDismissSnackBar} duration={3000} visible={showSnackBar}>
        SnackBar content
    </SnackBar>
        </MyComponent>
        <MyComponent>
      ...
      <Modal title="My Modal" onClose={handleModalClose} open={modalOpen}>
      ...
      <Drawer open={isDrawerOpen} onClose={handleDrawerClose}>
        ...
        <p>Some text inside the drawer.</p>
      </Drawer>
        </MyComponent>
        <MyComponent>
          <H1>Alerts Here</H1>
          {/* Alerta com tipo de mensagem: */}
          <Alert message="Este é um alerta de sucesso!" type="success"  onClose={() => handleClose()}/>
<Alert message="Este é um alerta de erro!" type="error" onClose={() => handleClose()} />
<Alert message="Este é um alerta de aviso!" type="warning" onClose={() => handleClose()} />
<Alert message="Este é um alerta informativo!" type="info" onClose={() => handleClose()} />
{/* Alerta com ação: */}
<Alert
...
<Alert message="Este alerta fechará em 5 segundos."  type="warning"  autoClose={5000} />
